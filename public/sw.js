...
const CACHE_NAME    = 'certimar-rv-v10';
const CACHE_ASSETS  = ['/', '/index.html', '/firebaseConfig.js', '/gmailAuth.js', '/metricsLog.js', '/pdfMail.js', '/firma.html', '/firmaPage.js', '/concesiones.js'];
